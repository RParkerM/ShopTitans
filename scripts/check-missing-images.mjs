...
const TYPE_TO_FOLDER = {
  ...
  'Dual Wield': 'Dual Wields', Aurasong: 'Aurasongs', Catalyst: 'Catalysts', Scythe: 'Scythes',
  Spell: 'Spells', Helmet: 'Helmets', 'Magician Hat': 'Magician Hats', Mask: 'Masks',
...
const SCRAPE_PAGES = [
  ...
  // TODO: confirm the site's URL slug for Scythes (guessed 'wh')
  { url: 'https://playshoptitans.com/blueprints/weapons/wh', folder: 'Scythes',        category: 'weapons',      subcategory: 'scythe' },
  // Armor
  ...
  // TODO: confirm the site's URL slug for Masks (guessed 'hk')
  { url: 'https://playshoptitans.com/blueprints/armor/hk',   folder: 'Masks',          category: 'armor',        subcategory: 'mask' },
